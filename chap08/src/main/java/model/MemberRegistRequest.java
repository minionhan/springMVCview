...
public class MemberRegistRequest {
	...
	public boolean isSamePasswordConfirmPassword(){
	   ...
	   public String toString() {
	      return "MemberRegistRequst [email=" + email + ", name=" + name + ", password=" + password + ", confirmPassword="
	            + confirmPassword + ", allowNoti=" + allowNoti + ", address=" + address + ", birthday=" + birthday
	            + "]";
	   }
