...
import errors.MemberNotFoundException;
import errors.NotMatchPasswordException;
import model.Address;
import model.MemberInfo;
import model.MemberModRequest;
...
public class MemberService {
   ...
   public void registNewMember(MemberRegistRequest memRegReq){
      MemberInfo mi = new MemberInfo("m"+nextMemberId,memRegReq.getName(), memRegReq.getEmail(), memRegReq.getPassword(),
